    ...
    <main className="min-h-screen bg-bg-primary text-text-primary">
      ...
      <section className="mx-auto grid min-h-screen w-full max-w-4xl items-center gap-8 px-5 py-8 md:grid-cols-[minmax(0,1fr)_18rem] md:px-8">
        <form onSubmit={submit} className="glass-panel rounded-2xl p-6 md:p-8">
          ...
          <button
            type="submit"
            className="mt-6 inline-flex h-12 w-full items-center justify-center gap-2 rounded-xl border border-accent-info/40 bg-accent-info/[0.18] px-5 text-sm font-black text-text-primary shadow-glass transition hover:bg-accent-info/25 disabled:cursor-not-allowed disabled:opacity-[0.45]"
