...
export type ResultFirstSectionCopy = {
  ...
  // "관찰 성향: ... 필요한 방향: ..."
  definition: string;
  // User-visible type name. It should only capture the observed current signal,
  // not the needed direction or prescription.
  displayName: string;
