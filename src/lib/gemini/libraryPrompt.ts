...
export function buildLibraryPrompt({
  ...
  return [
    ...
    "각 문장은 사용자가 '헐 이거 완전 내 얘기인데?'라고 느낄 만큼 구체적으로 작성한다. 추상적인 좋은 말만 반복하지 말고, 얼굴 메트릭과 생년월일 리듬에서 나온 근거를 붙인다.",
    ...
    "- romantic_match는 연애 궁합 관점으로 작성한다. 잘 맞는 사람 유형 2~4개, 왜 잘 맞는지, 잘 맞는 데이트 흐름, 조심할 점을 고양이 상담 톤으로 구체적으로 적는다.",
    "- physiognomy_summary와 saju_summary는 결과 요약용이다. 최소 2문장 이상, 빈 칭찬 말고 실제 관찰 근거를 넣는다.",
